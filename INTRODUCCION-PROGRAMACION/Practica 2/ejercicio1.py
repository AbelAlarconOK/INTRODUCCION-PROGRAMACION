...
#por el usuario.Correrlo tal cual estÃ¡ en Python. Luego reemplazar donde dice
#True por una expresiÃ³n lÃ³gicaque sea True o False segÃºn corresponda,
#en lugar de siempre True como ahora.

a = int(input("ingrese un numero entero"))
b = int(input("Ingrese un numero entero"))
c = int(input("Ingrese un numero entero"))
print("sted ingresÃ³ los valores:", a, b, c)
